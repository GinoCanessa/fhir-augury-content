# Crossgroup Projects — Prepared Tickets

This index lists all **32** prepared tickets for the **Crossgroup Projects** work group, grouped by specification.
...
- [CardX Hypertension Management (FHIR)](#cardx-hypertension-management-fhir)
...
## CardX Hypertension Management (FHIR)

*1 ticket(s) targeting the **CardX Hypertension Management (FHIR)** specification.*

| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-45371 | Section 4 title Card X to CardX | Triaged | 2024-04-26 | [FHIR-45371](./FHIR-45371.md) · [Jira](https://jira.hl7.org/browse/FHIR-45371) |

---

## US C-CDA on FHIR (FHIR)

*1 ticket(s) targeting the **US C-CDA on FHIR (FHIR)** specification.*

| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-50843 | Medication mapping guidance does not provide semantic clarity | Triaged | 2025-05-12 | [FHIR-50843](./FHIR-50843.md) · [Jira](https://jira.hl7.org/browse/FHIR-50843) |
...
| FHIR-33753 | Defining URL (Canonical URL) should be in THO not hl7.org/fhir.5 | Triaged | 2021-09-15 | [FHIR-33753](./FHIR-33753.md) · [Jira](https://jira.hl7.org/browse/FHIR-33753) |
...
*7 ticket(s) targeting the **US Vital Signs with Qualifying Extensions (FHIR)** specification.*

| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-28459 | How to differentiate average blood pressure calculates from one or different sites | Triaged | 2020-09-09 | [FHIR-28459](./FHIR-28459.md) · [Jira](https://jira.hl7.org/browse/FHIR-28459) |
| FHIR-28506 | Consider specifying that Observation.subject should reference a Patient resource. | Triaged | 2020-09-13 | [FHIR-28506](./FHIR-28506.md) · [Jira](https://jira.hl7.org/browse/FHIR-28506) |
| FHIR-28535 | Introduction should clarify relationship to other IGs | Triaged | 2020-09-14 | [FHIR-28535](./FHIR-28535.md) · [Jira](https://jira.hl7.org/browse/FHIR-28535) |
| FHIR-28536 | Links open in a new page | Triaged | 2020-09-14 | [FHIR-28536](./FHIR-28536.md) · [Jira](https://jira.hl7.org/browse/FHIR-28536) |
| FHIR-28537 | Example instances | Triaged | 2020-09-14 | [FHIR-28537](./FHIR-28537.md) · [Jira](https://jira.hl7.org/browse/FHIR-28537) |
| FHIR-28538 | Extension links go to detailed description pages | Triaged | 2020-09-14 | [FHIR-28538](./FHIR-28538.md) · [Jira](https://jira.hl7.org/browse/FHIR-28538) |
| FHIR-28541 | Profile XML Format: StructureDefinition xml and JSON | Triaged | **Type:** Change Request | **Priority:** Medium | 2020-09-14 | **Updated:** 2020-09-16 | [FHIR-28541](./FHIR-28541.md) · [Jira](https://jira.hl7.org/browse/FHIR-28541) |
