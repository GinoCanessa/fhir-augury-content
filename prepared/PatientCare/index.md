# Patient Care — Prepared Tickets

This index lists all **46** prepared tickets for the **Patient Care** work group, grouped by specification.
...
| FHIR-25267 | CareTeam: add status and status reason to careTeam.participant | Triaged | 2019-12-03 | [FHIR-25267](./FHIR-25267.md) · [Jira](https://jira.hl7.org/browse/FHIR-25267) |
| FHIR-26642 | Add event pattern to ClinicalImpression | Triaged | 2020-03-25 | [FHIR-26642](./FHIR-26642.md) · [Jira](https://jira.hl7.org/browse/FHIR-26642) |
| FHIR-28358 | Add the capability to record surgical timestamps in the Procedure resource | Triaged | 2020-08-26 | [FHIR-28358](./FHIR-28358.md) · [Jira](https://jira.hl7.org/browse/FHIR-28358) |
| FHIR-32048 | Update Condition's FHIR Maturity Level to Normative | Triaged | 2021-04-30 | [FHIR-32048](./FHIR-32048.md) · [Jira](https://jira.hl7.org/browse/FHIR-32048) |
| FHIR-46614 | Cardinality of ClinicalImpression.previous should be 0..* | Triaged | 2024-08-12 | [FHIR-46614](./FHIR-46614.md) · [Jira](https://jira.hl7.org/browse/FHIR-46614) |
| FHIR-54077 | CarePlan.activity.plannedActivityReference :: need to include vaccination request | Triaged | 2026-01-13 | [FHIR-54077](./FHIR-54077.md) · [Jira](https://jira.hl7.org/browse/FHIR-54077) |
| FHIR-54265 | Goal.statusReason :: rename to Goal.achievementStatusReason to improve semantic clarity | Triaged | 2026-01-14 | [FHIR-54265](./FHIR-54265.md) · [Jira](https://jira.hl7.org/browse/FHIR-54265) |
| FHIR-55388 | Change bodyStructure to CodeableReference | Triaged | 2026-01-22 | [FHIR-55388](./FHIR-55388.md) · [Jira](https://jira.hl7.org/browse/FHIR-55388) |

---

## International Birth And Child Model (FHIR)

*2 ticket(s) targeting the **International Birth And Child Model (FHIR)** specification.*

| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-41821 | Not clear whether the child right after birth is in scope of the IG (and if so till when?) | Triaged | 2023-08-21 | [FHIR-41821](./FHIR-41821.md) · [Jira](https://jira.hl7.org/browse/FHIR-41821) |
| FHIR-41825 | Unclarity in statements | Triaged | 2023-08-21 | [FHIR-41825](./FHIR-41825.md) · [Jira](https://jira.hl7.org/browse/FHIR-41825) |
...
| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-29977 | Merge the Functional Status IG and Cognitive Status IG. | Triaged | 2020-12-15 | [FHIR-29977](./FHIR-29977.md) · [Jira](https://jira.hl7.org/browse/FHIR-29977) |
| FHIR-29978 | Clarify IG's scope by expanding the narrative | Triaged | 2020-12-15 | [FHIR-29978](./FHIR-29978.md) · [Jira](https://jira.hl7.org/browse/FHIR-29978) |
| FHIR-29979 | Create a future roadmap | Triaged | 2020-12-15 | [FHIR-29979](./FHIR-29979.md) · [Jira](https://jira.hl7.org/browse/FHIR-29979) |
| FHIR-31509 | Differentiation between Self-Report Measures Versus Performance-Based Measures | Triaged | 2021-03-11 | [FHIR-31509](./FHIR-31509.md) · [Jira](https://jira.hl7.org/browse/FHIR-31509) |
...
*1 ticket(s) targeting the **US Physical Activity (FHIR)** specification.*

| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-41166 | The Care Plan should be the "cornerstone" of this IG referencing all the other profiles | Triaged | 2023-05-02 | [FHIR-41166](./FHIR-41166.md) · [Jira](https://jira.hl7.org/browse/FHIR-41166) |

---

## US SDOH Clinical Care (FHIR)

*2 ticket(s) targeting the **US SDOH Clinical Care (FHIR)** specification.*

| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-50072 | Coordination Platform CapabilityStatement — Contradictory Conformance Levels Between Resource Support, Search Parameters, and Interaction Summary | Triaged | 2025-03-18 | [FHIR-50072](./FHIR-50072.md) · [Jira](https://jira.hl7.org/browse/FHIR-50072) |
| FHIR-53383 | Improve definition for Community Based Organization | Triaged | 2026-02-27 | [FHIR-53383](./FHIR-53383.md) · [Jira](https://jira.hl7.org/browse/FHIR-53383) |

---

## Unspecified

*4 ticket(s) targeting the **Unspecified** specification.*

| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-10028 | Careplan: Provide ability to specify patient and/or provider preferences | Triaged **Priority:** Medium **Type:** Change Request | 2016-05-13 **Updated:** 2025-07-17 **Labels:** None | [FHIR-10028](./FHIR-10028.md) · [Jira](https://jira.hl7.org/browse/FHIR-10028) |
| FHIR-12993 | Please Create a NonMedicationAdministration object or an Administration object | Triaged | **Type:** Change Request | **Priority:** Medium | **Resolution:** Unresolved | 2017-03-08 | **Updated:** 2025-09-17 | [FHIR-12993](./FHIR-12993.md) · [Jira](https://jira.hl7.org/browse/FHIR-12993) |
| FHIR-17736 | Need guidance on representation of Concern | Triaged | 2018-08-28 | [FHIR-17736](./FHIR-17736.md) · [Jira](https://jira.hl7.org/browse/FHIR-17736) |
| FHIR-43617 | Need an Observation profile for strength-based rep measurements | Triaged | 2024-04-16 | [FHIR-43617](./FHIR-43617.md) · [Jira](https://jira.hl7.org/browse/FHIR-43617) |
