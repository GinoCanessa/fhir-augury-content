# Clinical Quality Information — Prepared Tickets

This index lists all **20** prepared tickets for the **Clinical Quality Information** work group, grouped by specification.
...
|-----|-------|--------|------|-------|
| FHIR-50686 | MeasureReport | Triaged | 2025-05-04 | [FHIR-50686](./FHIR-50686.md) · [Jira](https://jira.hl7.org/browse/FHIR-50686) |

---

## Quality Measures (FHIR)

*1 ticket(s) targeting the **Quality Measures (FHIR)** specification.*

| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-55952 | Add examples of risk-adjusted measures | Triaged | 2026-02-24 | [FHIR-55952](./FHIR-55952.md) · [Jira](https://jira.hl7.org/browse/FHIR-55952) |

---

## US Da Vinci DEQM (FHIR)

*1 ticket(s) targeting the **US Da Vinci DEQM (FHIR)** specification.*

| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-56279 | Clarify guidance on score calculation | Triaged | 2026-04-03 | [FHIR-56279](./FHIR-56279.md) · [Jira](https://jira.hl7.org/browse/FHIR-56279) |

---

## US Da Vinci Value-Based Performance Reporting (FHIR)

*1 ticket(s) targeting the **US Da Vinci Value-Based Performance Reporting (FHIR)** specification.*

| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-42405 | Information included in reports | Triaged | 2023-09-01 | [FHIR-42405](./FHIR-42405.md) · [Jira](https://jira.hl7.org/browse/FHIR-42405) |
...
*1 ticket(s) targeting the **US Quality Measures (FHIR)** specification.*

| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-50090 | Measures With Multiple Populations | Triaged | 2025-03-21 | [FHIR-50090](./FHIR-50090.md) · [Jira](https://jira.hl7.org/browse/FHIR-50090) |
...
| Key | Title | Status | Date | Links |
|-----|-------|--------|------|-------|
| FHIR-45681 | CQFM Publishable Measure Short Description revision | — | — | [FHIR-45681](./FHIR-45681.md) · [Jira](https://jira.hl7.org/browse/FHIR-45681) |
| FHIR-45686 | CQFM Composite Measure Short Description Revision | — | — | [FHIR-45686](./FHIR-45686.md) · [Jira](https://jira.hl7.org/browse/FHIR-45686) |
